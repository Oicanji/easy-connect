...
class MainWindow(QMainWindow):
    ...
    def _build(self) -> None:
        ...
        subtitle = QLabel("Conexões SSH com comandos globais no terminal")
        ...
        credit = QLabel("por Ignacio Sepúlveda")
        credit.setObjectName("Hint")
        header_layout.addWidget(credit, 0, Qt.AlignmentFlag.AlignTop)
